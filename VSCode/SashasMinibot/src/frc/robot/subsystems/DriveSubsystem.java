...
public class DriveSubsystem extends SubsystemBase {
  ...
  public static final double k_maxSpeed = 1092;
  public static final double k_leftMinPower = 0.26;
  public static final double k_rightMinPower = 0.26;
  private static final double k_Fleft = 1.1/k_maxSpeed;
  private static final double k_Fright = 1.02/k_maxSpeed;
  private static final double k_P = 0.0015; // .0059
  private static final double k_I = 0.00004;
  /**
