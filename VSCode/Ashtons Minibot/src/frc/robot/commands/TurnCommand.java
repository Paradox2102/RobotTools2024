...
public class TurnCommand extends Command {
  ...
  private final double k_ticksperdegree = 1800/360;
  /**
   * Creates a new TurnCommand.
   *
   * @param subsystem The subsystem used by this command.
   */
  public TurnCommand(DriveSubsystem subsystem, double angle, double speed) {
  ...
  if(m_angle<0)
  {
      m_subsystem.setSpeed(-m_speed, m_speed); //Left
  } else
  {
    m_subsystem.setSpeed(m_speed, -m_speed); //right
  }
}
