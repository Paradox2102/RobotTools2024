...
public class TurnCommand extends Command {
  ...
  private double k_angleRatio = 4550.0 / 360.0;
  /**
   * Creates a new TurnCommand.
   *
   * @param subsystem The subsystem used by this command.
   * @param speed the speed to speed at
   * @param angle the angle to angle at
   */
  ...
  public boolean isFinished() {
    ...
    return (Math.abs(delta) >= Math.abs(k_angleRatio * m_angle));
  }
}
