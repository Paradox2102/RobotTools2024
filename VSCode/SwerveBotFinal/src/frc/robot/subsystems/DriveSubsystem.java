...
public class DriveSubsystem extends SubsystemBase {
  ...
  private final double k_cameraAngle = 3.5;
  private final double k_wheelSeparation = (4.607 * 2.54) / 100;
  private final double k_driveBaseRadius = Math.sqrt(k_wheelSeparation * k_wheelSeparation)/2;
  ...
  public static final double k_maxDriveSpeed = 2500;
